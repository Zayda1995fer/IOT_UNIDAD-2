...
REED_PIN = 14  # GPIO donde está conectado el Reed Switch
reed_switch = Pin(REED_PIN, Pin.IN, Pin.PULLUP)  # Configurar con resistencia pull-up interna
...
while True:
    ...
    sleep(0.5)  # Leer el estado cada 500 ms
